    ...
    <section className="py-16 bg-surface">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-12 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
              {skills.map((s) => (
                <div
                  ...
                  <div className="w-full h-2 bg-border rounded mb-2 relative overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-primary to-accent rounded transition-all duration-500"
                      style={{ width: `${s.level}%` }}
                    />
                  </div>
                  <ol className="pl-2 text-subText text-[0.98rem] list-decimal list-inside space-y-1 text-left">
          ...
          <div>
            <h3 className="text-xl font-semibold text-text my-4 text-center">
              Soft Skills
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {softSkills.map((skill) => (
                <div
                  ...
                  <ul className="space-y-2 list-disc pl-3 ml-2">
                    {skill.details.map((detail, index) => (
                      <li
                        key={index}
                        className="ext-sm text-subText text-left">
                        {detail}
                      </li>
                    ))}
                  </ul>
