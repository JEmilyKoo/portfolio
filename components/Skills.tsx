...
export default function Skills() {
  return (
    <section className="py-16 bg-surface">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-extrabold mb-4">기술과 역량</h2>
        ...
        <div className="space-y-12 text-center">
          <div>
            <h3 className="text-xl font-semibold text-text mb-4">Technical Skills</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-text my-4 text-center">Soft Skills</h3>
